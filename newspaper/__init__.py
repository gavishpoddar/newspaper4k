...
def get_entire_html(url: str, language: Optional[str] = None, **kwargs) -> str:
    """Shortcut function to fetch and parse a newspaper article from a URL and return the entire HTML.
